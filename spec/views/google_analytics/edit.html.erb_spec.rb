...
describe "google_analytics/edit" do
  before(:each) do
  ...
  it "renders the edit google_analytic form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => google_analytics_path(@google_analytic), :method => "post" do
